# Comparing `tmp/invest_guard-0.1.2.tar.gz` & `tmp/invest-guard-0.1.3.tar.gz`
...
## Comparing `invest_guard-0.1.2.tar` & `invest-guard-0.1.3.tar`
...
### Comparing `invest_guard-0.1.2/PKG-INFO` & `invest-guard-0.1.3/PKG-INFO`
...
### Comparing `invest_guard-0.1.2/README.md` & `invest-guard-0.1.3/README.md`

 * *Files identical despite different names*

### Comparing `invest_guard-0.1.2/invest_guard.egg-info/PKG-INFO` & `invest-guard-0.1.3/invest_guard.egg-info/PKG-INFO`
...
### Comparing `invest_guard-0.1.2/setup.py` & `invest-guard-0.1.3/setup.py`
