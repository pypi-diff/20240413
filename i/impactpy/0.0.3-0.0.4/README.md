# Comparing `tmp/impactpy-0.0.3.tar.gz` & `tmp/impactpy-0.0.4.tar.gz`

## Comparing `impactpy-0.0.3.tar` & `impactpy-0.0.4.tar`
...
### Comparing `impactpy-0.0.3/ImpactPy.egg-info/SOURCES.txt` & `impactpy-0.0.4/ImpactPy.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `impactpy-0.0.3/build/lib/src/models/impact_model.py` & `impactpy-0.0.4/build/lib/src/models/impact_model.py`

 * *Files identical despite different names*

### Comparing `impactpy-0.0.3/build/lib/testing/test_cfg.py` & `impactpy-0.0.4/build/lib/testing/test_cfg.py`

 * *Files identical despite different names*

### Comparing `impactpy-0.0.3/impactpy/models/impact_model.py` & `impactpy-0.0.4/impactpy/models/impact_model.py`

 * *Files identical despite different names*

### Comparing `impactpy-0.0.3/impactpy_lachlanbaxter.egg-info/PKG-INFO` & `impactpy-0.0.4/impactpy_lachlanbaxter.egg-info/PKG-INFO`

 * *Files identical despite different names*

### Comparing `impactpy-0.0.3/impactpy_lachlanbaxter.egg-info/SOURCES.txt` & `impactpy-0.0.4/impactpy_lachlanbaxter.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `impactpy-0.0.3/pyproject.toml` & `impactpy-0.0.4/pyproject.toml`
