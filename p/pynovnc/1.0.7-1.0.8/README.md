# Comparing `tmp/pynovnc-1.0.7.tar.gz` & `tmp/pynovnc-1.0.8.tar.gz`
...
## Comparing `pynovnc-1.0.7.tar` & `pynovnc-1.0.8.tar`
...
### Comparing `pynovnc-1.0.7/PKG-INFO` & `pynovnc-1.0.8/PKG-INFO`
...
### Comparing `pynovnc-1.0.7/README.md` & `pynovnc-1.0.8/README.md`

 * *Files identical despite different names*

### Comparing `pynovnc-1.0.7/pynovnc/__init__.py` & `pynovnc-1.0.8/pynovnc/__init__.py`

 * *Files identical despite different names*

### Comparing `pynovnc-1.0.7/pynovnc.egg-info/PKG-INFO` & `pynovnc-1.0.8/pynovnc.egg-info/PKG-INFO`
...
### Comparing `pynovnc-1.0.7/setup.py` & `pynovnc-1.0.8/setup.py`
